...
session_start(); 
    $usersData = array() ;
    $passData = array() ;
    if(isset($_POST['name'])  && isset($_POST['number']) && isset($_POST['pass'])  && isset($_POST['re_pass'])){
        ...
        if( $_POST['pass'] == $_POST['re_pass'] ){
            ...
            $usersData[] = $_SESSION['user'] ;
            // $usersData[]["numberNew"] = $_SESSION['number'] ;
            $passData[]= $_SESSION['pass'] ;
            echo "<pre>";
            print_r($usersData) ;
            print_r($passData) ;
...
?>
<!-- $_POST['name'] >= 3 &&  $_POST['number'] = 10 && $_POST['pass'] >=8 && -->
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
        ...
        <title>register.mini DashBoard</title>
